export const CATEGORIES = [
  ...
  { slug: "numpy-fundamentals", label: "NumPy Fundamentals", icon: "🔢" },
  { slug: "pytorch-basics", label: "PyTorch Basics", icon: "🔰" },
  ...
  { slug: "pytorch-coding", label: "PyTorch Advanced", icon: "🔥" },
  { slug: "agents-tool-use", label: "AI Agents & Tool Use", icon: "🤖" },
...
export const CATEGORY_COLORS = {
  ...
  "numpy-fundamentals": "from-yellow-600 to-yellow-800",
  "pytorch-basics": "from-amber-600 to-amber-800",
  "agents-tool-use": "from-indigo-600 to-indigo-800",
